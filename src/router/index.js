...
export default new Router({
    ...
    routes: [
        ...
        },
        {
            ...
            component: resolve => require(['@/components/page/new_home_detail'], resolve),
        },
        {
        ...
        },
        {
            ...
            component: resolve => require(['@/components/page/second_hand_house'], resolve),
        },
        {
            path: '/find_new_home', //找新房
            name: 'find_new_home',
            component: resolve => require(['@/components/page/find_new_home'], resolve),
        },
        {
            path: '/dynamic', //最新动态
            name: 'dynamic',
...

        {
            ...
            component: resolve => require(['@/components/page/second_house_detail'], resolve),
        },
        {
            path: '/house_type_all', //全部户型
            name: 'house_type_all',
            component: resolve => require(['@/components/page/house_type_all'], resolve),
        },
        {
